...
-->
<link rel="stylesheet" href="${rootPath}/assets/css/daumeditor/editor.css" type="text/css" charset="utf-8"/>
<script src="${rootPath}/assets/js/common/daumeditor/editor_loader.js" type="text/javascript" charset="utf-8"></script>
    ...
    <ul class="tx-bar tx-bar-left tx-group-list">
        <li class="tx-list">
            <div unselectable="on" id="tx_image" class="tx-image tx-btn-trans">
                <a href="javascript:;" title="사진" class="tx-text"></a>
            </div>
        </li>
        <!-- 이미지 첨부 버튼 끝 -->
        <!-- 					<li class="tx-list"> -->
        ...
        <li class="tx-list">
            ...
            <div id="tx_richtextbox_menu" class="tx-richtextbox-menu tx-menu">
                ...
                <div class="tx-menu-footer">
                    <img class="tx-menu-confirm" src="${rootPath}/assets/images/editor/btn_confirm.gif?rv=1.0.1" alt=""/>
                    <img class="tx-menu-cancel" hspace="3" src="${rootPath}/assets/images/editor/btn_cancel.gif?rv=1.0.1" alt=""/>
                </div>
            </div>
        </li>
        <li class="tx-list">
...
<div id="tx_canvas" class="tx-canvas">
    <div id="tx_loading" class="tx-loading"><div><img src="${rootPath}/assets/images/editor/loading2.png" width="113" height="21" align="absmiddle"/></div></div>
...
<!-- 		<img id="tx_resize_holder" src="/js/library/daumeditor/images/icon/editor/skin/01/btn_drag01.gif" width="58" height="12" unselectable="on" alt="" /> -->
<!-- 	</div> -->
<!-- 편집영역 끝 -->
<!-- 첨부박스 시작 -->
<!-- 파일첨부박스 Start -->
<div id="tx_attach_div" class="tx-attach-div">
    ...
    <div id="tx_attach_box" class="tx-attach-box">
        <div class="tx-attach-box-inner">
            <div id="tx_attach_preview" class="tx-attach-preview"><p></p><img src="${rootPath}/assets/images/editor/pn_preview.gif" width="147" height="108" unselectable="on"/></div>
...
<script type="text/javascript">
    var config = {
        ...
        txIconPath: "${rootPath}/assets/images/editor/", /*에디터에 사용되는 이미지 디렉터리, 필요에 따라 수정한다. */
        txDecoPath: "${rootPath}/assets/images/deco/contents/", /*본문에 사용되는 이미지 디렉터리, 서비스에서 사용할 때는 완성된 컨텐츠로 배포되기 위해 절대경로로 수정한다. */
        canvas: {
            styles: {
                color: "#123456", /* 기본 글자색 */
