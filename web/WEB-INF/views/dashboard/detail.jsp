...
<section  class="container">
    <!-- 확대보기 레이어 팝업 -->
    <%--<aside class="layer_popup" style="display: block;">--%>
        <%--<section class="layer_wrap i_type05">--%>
            <%--<article class="layer_area">--%>
                <%--<div class="mp_header">--%>
                    <%--<h2>작업자 선택</h2>--%>
                    <%--<div>--%>
                        <%--<button class="refl_btn"></button>--%>
                        <%--<button class="zoom_btn on"></button>--%>
                    <%--</div>--%>
                <%--</div>--%>

                <%--<div class="mp_contents ">--%>
                    <%--<div class="mc_element h_mode">--%>
    ...
    <article class="main_title_area">
        <!-- 2depth 타이틀 Start-->
        <h3 class="1depth_title">${paramBean.areaName}</h3>
        <!-- 마키 영역 Start -->
        <div class="marquee">
