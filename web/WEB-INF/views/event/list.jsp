        ...
        <div class="table_contents">
            ...
            <table class="t_defalut t_type01 t_style02">
                ...
                <tr>
                    ...
                    <th><spring:message code="event.column.eventAction"/></th>
                        ...
                        <c:forEach var="event" items="${events}">
                            ...
                            <%--<tr onclick="moveDetail(String('${event.eventId}'));">--%>
                                ...
                                <c:if test="${!empty event.actionId}">
                                    <td title="" class="t_center">
                                        <button class="btype02 bstyle02" onclick="javascript:popup_openButton('${event.actionId}');return false;">${event.actionId}</button>
                                    </td>
                                </c:if>
                                <c:if test="${empty event.actionId}">
                                    <td></td>
