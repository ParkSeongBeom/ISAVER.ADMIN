...
<div class="window_wrap">
    <section class="container sub_area">
        ...
        <article class="sub_title_area">
            <!-- 2depth 타이틀 Start-->
            <h3 class="1depth_title"><spring:message code="common.title.assetsUserList"/></h3>
            <!-- 2depth 타이틀 End -->
...
<script type="text/javascript">
    ...
    var urlConfig = {
        'listUrl':'${rootPath}/assets/popup.html'
    };
    ...
    function addTarget(){
        ...
        for (var i = 0; i < assetsCheck.length; i++) {
            var data = assetsCheck[i].parentNode.parentNode;
            ...
            var result = opener.addTarget(userId, orgName, userName, classification);
