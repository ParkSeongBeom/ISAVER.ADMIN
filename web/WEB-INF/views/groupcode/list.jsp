            ...
            <table class="t_defalut t_type01 t_style02">
                ...
                <thead>
                    <tr>
                        ...
                        <th><spring:message code="groupcode.column.groupCodeName"/></th>
...
<script type="text/javascript">
    ...
    function findListCode(groupCodeId){
        ...
        sendAjaxPostRequest(urlConfig['findListCodeUrl'],{"id":groupCodeId},findListCode_successHandler,findListCode_errorHandler);
    }
